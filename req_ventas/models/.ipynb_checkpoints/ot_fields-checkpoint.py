...
class SaleOrder(models.Model):
    ...
    x_equipo_asignado = fields.Selection([('eq21','Equipo 21'),('eq22','Equipo 22'),('eq23','Equipo 23'),('eq24','Equipo 24'),('eqb1','Equipo Bombas 1'),('eqb2','Equipo Bombas 2'),('eqb3','Equipo Bombas 3')],string='Equipo asignado')
    ...
    configuracion_perforacion = fields.Html(string='Configuracion de perforación')
    configuracion_perforación = fields.Html(string='Configuracion perforación')
