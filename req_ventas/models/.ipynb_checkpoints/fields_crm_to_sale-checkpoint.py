...
class SaleOrder(models.Model):
    ...
    profundidad_profundizar = fields.Integer(string='Metros a profundizar: ')
    diametro_profundizar = fields.Integer(string='Diametro de profundización: ')
    ...
    diametro_pozo = fields.Char(string='Diametro: ',store=True)
    x_profundidad_pozo = fields.Integer(related='opportunity_id.x_profundidad',string='Profundidad.: ')
    profundidad_calculada = fields.Integer(string="Profundidad: ",default=get_default_profundidad_calculada,store=True)
    ...
    duracion_servicio1 = fields.Integer(string='Duración',store=True)
    ...
    duracion_s2 = fields.Integer(string='Duración sistema de bombeo',store=True)
