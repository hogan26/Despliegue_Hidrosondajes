...
class SaleOrder(models.Model):
    ...
    sale_order_template_id_prueba = fields.Many2one('sale.order.template',string='Plantilla de presupuesto',readonly=True,states={'draft': [('readonly', False)], 'sent': [('readonly', False)]})
