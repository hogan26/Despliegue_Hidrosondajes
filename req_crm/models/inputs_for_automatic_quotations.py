...
class Lead(models.Model):
    ...
    x_servicios_requeridos = fields.Selection([('s1', 'S1'),('s2','S2'),('s3','S3'),('s1s2','S1 + S2'),('s1s2s3','S1 + S2 + S3'),('s2s3','S2 + S3'),('s4','S4')],string='Servicios requeridos', required=True, default='s1')
    ...
    x_prueba_bombeo = fields.Selection([('sinprueba','Sin Prueba de Bombeo'),('pb2hrs','Prueba de bombeo 2hrs'),('pb4hrs','Prueba de bombeo 4hrs'),('pb24hrs','Prueba de bombeo DGA 24hrs')],string='Prueba de bombeo (antiguo)')
    ...
    duracion_s1 = fields.Integer(string='Duracion Servicio 1',default=get_default_duracion_s1)
    #servicio 2
    ...
    duracion_s2 = fields.Integer(string='Duracion Servicio 2')
    ...
    x_duracion_s3 = fields.Integer(string='Duracion Servicio 3')
